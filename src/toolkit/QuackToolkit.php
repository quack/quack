...
import(CODEGEN, 'js/expr/ListExprCodeGen');
import(CODEGEN, 'js/expr/ObjectExprCodeGen');
import(CODEGEN, 'js/expr/TypeExprCodeGen');
import(CODEGEN, 'js/expr/PartialFuncExprCodeGen');
import(CODEGEN, 'js/expr/WhereExprCodeGen');
import(CODEGEN, 'js/expr/PostfixExprCodeGen');
import(CODEGEN, 'js/expr/AtomExprCodeGen');
import(CODEGEN, 'js/expr/RegexExprCodeGen');
import(CODEGEN, 'js/expr/TupleExprCodeGen');
import(CODEGEN, 'js/expr/NameExprCodeGen');
import(CODEGEN, 'js/expr/CallExprCodeGen');
import(CODEGEN, 'js/expr/OperatorExprCodeGen');
import(CODEGEN, 'js/expr/LambdaExprCodeGen');
import(CODEGEN, 'js/expr/BlockExprCodeGen');
import(CODEGEN, 'js/expr/RangeExprCodeGen');
import(CODEGEN, 'js/expr/PrefixExprCodeGen');
import(CODEGEN, 'js/expr/MapExprCodeGen');
import(CODEGEN, 'js/expr/NumberExprCodeGen');
import(CODEGEN, 'js/expr/AccessExprCodeGen');
import(CODEGEN, 'js/expr/TernaryExprCodeGen');
import(CODEGEN, 'js/expr/MatchExprCodeGen');
import(CODEGEN, 'js/expr/StringExprCodeGen');
import(CODEGEN, 'js/stmt/BreakStmtCodeGen');
import(CODEGEN, 'js/stmt/DataStmtCodeGen');
import(CODEGEN, 'js/stmt/FnStmtCodeGen');
import(CODEGEN, 'js/stmt/ReturnStmtCodeGen');
import(CODEGEN, 'js/stmt/IfStmtCodeGen');
import(CODEGEN, 'js/stmt/ForeachStmtCodeGen');
import(CODEGEN, 'js/stmt/TypeStmtCodeGen');
import(CODEGEN, 'js/stmt/LetStmtCodeGen');
import(CODEGEN, 'js/stmt/ExprStmtCodeGen');
import(CODEGEN, 'js/stmt/TypeConsStmtCodeGen');
import(CODEGEN, 'js/stmt/FnSignatureStmtCodeGen');
import(CODEGEN, 'js/stmt/WhileStmtCodeGen');
import(CODEGEN, 'js/stmt/LabelStmtCodeGen');
import(CODEGEN, 'js/stmt/ProgramStmtCodeGen');
import(CODEGEN, 'js/stmt/ContinueStmtCodeGen');
import(CODEGEN, 'js/stmt/BlockStmtCodeGen');
import(CODEGEN, 'js/stmt/ElifStmtCodeGen');
